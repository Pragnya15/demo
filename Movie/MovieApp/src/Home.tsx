...
<br/>
    <div className="container" style={{border:'2px solid black',padding:'20px',borderRadius:'10px'}}>
            <div className="row">
                {trend && trend.map((movie, index) => (
                    <div className="col-md-4 mb-3" key={index}>
                        <div className="card" style={{background: 'radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(26,26,80,1) 35%, rgba(0,0,0,1) 100%)',color:'white'}}>
